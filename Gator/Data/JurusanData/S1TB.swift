...
enum S1TB_Data {
    static func create() -> Jurusan {
        let jurusan = Jurusan(nama: "S1 - Teknik Bioproses")
        let semester1 = Semester(nomor: 1, jurusan: jurusan)
        let matkul1A = MataKuliah(nama: "Pengantar Teknik Bioproses", sks: 2, semester: semester1)
        ...
        let matkul1B = MataKuliah(nama: "Matematika Dasar I", sks: 2, semester: semester1)
        ...
        let matkul1C = MataKuliah(nama: "Fisika Dasar IA", sks: 3, semester: semester1)
        ...
        let matkul1D = MataKuliah(nama: "Kimia Dasar A", sks: 3, semester: semester1)
        ...
        let matkul1E = MataKuliah(nama: "Bahasa Inggris I", sks: 3, semester: semester1)
        ...
        let matkul1F = MataKuliah(nama: "Pembentukan Karakter Del", sks: 3, semester: semester1)
        ...
        let matkul1G = MataKuliah(nama: "Penyelesaian Masalah di Dunia Digital", sks: 3, semester: semester1)
        matkul1G.komponen = [KomponenNilai(nama: "Quis", bobot: 20, mataKuliah: matkul1G),
                             KomponenNilai(nama: "UAS", bobot: 80, mataKuliah: matkul1G)]
        ...
        let matkul2A = MataKuliah(nama: "Kimia Organik", sks: 2, semester: semester2)
        ...
        let matkul2B = MataKuliah(nama: "Praktikum Kimia Organik", sks: 2, semester: semester2)
        ...
        let matkul2C = MataKuliah(nama: "Praktikum Mikrobiologi Umum", sks: 3, semester: semester2)
        ...
        let matkul2D = MataKuliah(nama: "Mikrobiologi Umum", sks: 3, semester: semester2)
        ...
        let matkul2E = MataKuliah(nama: "Termodinamika Kimiawi", sks: 3, semester: semester2)
        ...
        let matkul2F = MataKuliah(nama: "Praktikum Termodinamika Kimiawi", sks: 1, semester: semester2)
        ...
        let matkul2G = MataKuliah(nama: "Matematika Dasar II", sks: 3, semester: semester2)
        ...
        let matkul2H = MataKuliah(nama: "Agama", sks: 2, semester: semester2)
        ...
        let matkul2I = MataKuliah(nama: "Bahasa Inggris II", sks: 3, semester: semester2)
        matkul2I.komponen = [KomponenNilai(nama: "Tugas", bobot: 20, mataKuliah: matkul2I),
                             KomponenNilai(nama: "Quis", bobot: 15, mataKuliah: matkul2I),
                             KomponenNilai(nama: "UTS", bobot: 20, mataKuliah: matkul2I),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul2I),
                             KomponenNilai(nama: "Tambahan 1", bobot: 15, mataKuliah: matkul2I)]
        semester2.mataKuliah = [matkul2A, matkul2B, matkul2C, matkul2D, matkul2E, matkul2F, matkul2G, matkul2H, matkul2I]
        
        let semester3 = Semester(nomor: 3, jurusan: jurusan)
        let matkul3A = MataKuliah(nama: "Analisis Matematika Teknik Bioproses", sks: 2, semester: semester3)
        ...
        let matkul3B = MataKuliah(nama: "Biokimia", sks: 2, semester: semester3)
        ...
        let matkul3C = MataKuliah(nama: "Praktikum Biokimia", sks: 3, semester: semester3)
        ...
        let matkul3D = MataKuliah(nama: "Neraca Massa dan Energi", sks: 3, semester: semester3)
        ...
        let matkul3E = MataKuliah(nama: "Genetika dan Biologi Molekuler", sks: 3, semester: semester3)
        ...
        let matkul3F = MataKuliah(nama: "Praktikum Genetika & Biologi Molekuler", sks: 3, semester: semester3)
        ...
        let matkul3G = MataKuliah(nama: "Pengantar Komputasi Bioproses", sks: 3, semester: semester3)
        ...
        let matkul3H = MataKuliah(nama: "Probabilitas dan Statistika", sks: 2, semester: semester3)
        ...
        let matkul3I = MataKuliah(nama: "Konstruksi Sosial Teknologi", sks: 3, semester: semester3)
        matkul3I.komponen = [KomponenNilai(nama: "Tugas", bobot: 20, mataKuliah: matkul3I),
                             KomponenNilai(nama: "Quis", bobot: 15, mataKuliah: matkul3I),
                             KomponenNilai(nama: "UTS", bobot: 20, mataKuliah: matkul3I),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul3I),
                             KomponenNilai(nama: "Tambahan 1", bobot: 15, mataKuliah: matkul3I)]
        semester3.mataKuliah = [matkul3A, matkul3B, matkul3C, matkul3D, matkul3E, matkul3F, matkul3G, matkul3H, matkul3I]
        
        let semester4 = Semester(nomor: 4, jurusan: jurusan)
        let matkul4A = MataKuliah(nama: "Analisis Instrumental", sks: 2, semester: semester4)
        ...
        let matkul4B = MataKuliah(nama: "Praktikum Analisis Instrumental", sks: 3, semester: semester4)
        ...
        let matkul4C = MataKuliah(nama: "Metabolisme Mikroba", sks: 3, semester: semester4)
        ...
        let matkul4D = MataKuliah(nama: "Teknologi Enzim", sks: 3, semester: semester4)
        ...
        let matkul4E = MataKuliah(nama: "Utilitas dan Pengolahan Limbah", sks: 3, semester: semester4)
        ...
        let matkul4F = MataKuliah(nama: "Operasi Fisik Pendukung I", sks: 2, semester: semester4)
        ...
        let matkul4G = MataKuliah(nama: "Fenomena Transpor", sks: 3, semester: semester4)
        ...
        let matkul4H = MataKuliah(nama: "Pengantar Bahan Lunak", sks: 3, semester: semester4)
        matkul4H.komponen = [KomponenNilai(nama: "Praktikum", bobot: 15, mataKuliah: matkul4H),
                             KomponenNilai(nama: "Quis", bobot: 10, mataKuliah: matkul4H),
                             KomponenNilai(nama: "UTS", bobot: 25, mataKuliah: matkul4H),
                             KomponenNilai(nama: "UAS", bobot: 25, mataKuliah: matkul4H),
                             KomponenNilai(nama: "Tugas", bobot: 25, mataKuliah: matkul4H)]
        ...
        let matkul5A = MataKuliah(nama: "Kinetika dan Katalisa", sks: 3, semester: semester5)
        ...
        let matkul5B = MataKuliah(nama: "Pengendalian dan Instrumentasi Proses", sks: 2, semester: semester5)
        ...
        let matkul5C = MataKuliah(nama: "Praktikum Pengendalian & Instrumentasi Proses", sks: 3, semester: semester5)
        ...
        let matkul5D = MataKuliah(nama: "Mikrobiologi Industri", sks: 3, semester: semester5)
        ...
        let matkul5E = MataKuliah(nama: "Operasi Fisik Pendukung II", sks: 2, semester: semester5)
        ...
        let matkul5F = MataKuliah(nama: "Pancasila", sks: 2, semester: semester5)
        ...
        let matkul6A = MataKuliah(nama: "Laboratorium Teknik Bioproses", sks: 3, semester: semester6)
        ...
        let matkul6B = MataKuliah(nama: "Teknik Reaktor Bioproses", sks: 2, semester: semester6)
        ...
        let matkul6C = MataKuliah(nama: "Analisis Keekonomian Proyek Bioproses", sks: 3, semester: semester6)
        ...
        let matkul6D = MataKuliah(nama: "Perancangan Alat", sks: 3, semester: semester6)
        ...
        let matkul6E = MataKuliah(nama: "Operasi Fisik Pendukung III", sks: 2, semester: semester6)
        ...
        let matkul6F = MataKuliah(nama: "Bioteknologi Lingkungan", sks: 2, semester: semester6)
        ...
        let matkul6G = MataKuliah(nama: "Bioetika", sks: 2, semester: semester6)
        ...
        let matkul6H = MataKuliah(nama: "Pengenalan Basis Data dan Sistem Informasi", sks: 3, semester: semester6)
        ...
        let matkul6I = MataKuliah(nama: "Kewarganegaraan", sks: 3, semester: semester6)
        matkul6I.komponen = [KomponenNilai(nama: "Praktikum", bobot: 15, mataKuliah: matkul6I),
                             KomponenNilai(nama: "Tugas", bobot: 15, mataKuliah: matkul6I),
                             KomponenNilai(nama: "Quis", bobot: 10, mataKuliah: matkul6I),
                             KomponenNilai(nama: "UTS", bobot: 30, mataKuliah: matkul6I),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul6I)]
        let matkul6J = MataKuliah(nama: "Manajemen Proyek Rekayasa", sks: 2, semester: semester6)
        matkul6J.komponen = [KomponenNilai(nama: "Tugas", bobot: 15, mataKuliah: matkul6J),
                             KomponenNilai(nama: "Quis", bobot: 15, mataKuliah: matkul6J),
                             KomponenNilai(nama: "UTS", bobot: 35, mataKuliah: matkul6J),
                             KomponenNilai(nama: "UAS", bobot: 35, mataKuliah: matkul6J)]
        
        semester6.mataKuliah = [matkul6A, matkul6B, matkul6C, matkul6D, matkul6E, matkul6F, matkul6H, matkul6I, matkul6J]
        
        let semester7 = Semester(nomor: 7, jurusan: jurusan)
        let matkul7A = MataKuliah(nama: "Metodologi Penelitian", sks: 3, semester: semester7)
        matkul7A.komponen = [KomponenNilai(nama: "Tugas", bobot: 15, mataKuliah: matkul7A),
                             KomponenNilai(nama: "Quis", bobot: 10, mataKuliah: matkul7A),
                             KomponenNilai(nama: "Praktikum", bobot: 15, mataKuliah: matkul7A),
                             KomponenNilai(nama: "UTS", bobot: 30, mataKuliah: matkul7A),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul7A)]
        let matkul7B = MataKuliah(nama: "Kerja Praktik", sks: 2, semester: semester7)
        matkul7B.komponen = [KomponenNilai(nama: "Pembimbing Akademik", bobot: 35, mataKuliah: matkul7B),
                             KomponenNilai(nama: "Pembimbing Lapangan", bobot: 45, mataKuliah: matkul7B),
                             KomponenNilai(nama: "Koordinator", bobot: 20, mataKuliah: matkul7B)]
        let matkul7C = MataKuliah(nama: "Etika Keprofesian", sks: 3, semester: semester7)
        matkul7C.komponen = [KomponenNilai(nama: "Proyek", bobot: 10, mataKuliah: matkul7C),
                             KomponenNilai(nama: "Praktikum", bobot: 20, mataKuliah: matkul7C),
                             KomponenNilai(nama: "Quis", bobot: 10, mataKuliah: matkul7C),
                             KomponenNilai(nama: "UTS", bobot: 30, mataKuliah: matkul7C),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul7C)]
        let matkul7D = MataKuliah(nama: "Sintesa Perancangan Proses", sks: 3, semester: semester7)
        ...
        let matkul7E = MataKuliah(nama: "Aplikasi dan Industri Teknik Bioproses", sks: 2, semester: semester7)
        matkul7E.komponen = [KomponenNilai(nama: "Tugas", bobot: 15, mataKuliah: matkul7E),
                             KomponenNilai(nama: "Quis", bobot: 15, mataKuliah: matkul7E),
                             KomponenNilai(nama: "UTS", bobot: 35, mataKuliah: matkul7E),
                             KomponenNilai(nama: "UAS", bobot: 35, mataKuliah: matkul7E)]
        let matkul7F = MataKuliah(nama: "Teknologi Pangan", sks: 2, semester: semester7)
        matkul7F.komponen = [KomponenNilai(nama: "Tugas", bobot: 20, mataKuliah: matkul7F),
                             KomponenNilai(nama: "Quis", bobot: 20, mataKuliah: matkul7F),
                             KomponenNilai(nama: "UTS", bobot: 30, mataKuliah: matkul7F),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul7F)]
        let matkul7G = MataKuliah(nama: "Bioinformatika", sks: 2, semester: semester7)
        matkul7G.komponen = [KomponenNilai(nama: "Partisipasi", bobot: 5, mataKuliah: matkul7G),
                             KomponenNilai(nama: "Quis", bobot: 20, mataKuliah: matkul7G),
                             KomponenNilai(nama: "UTS", bobot: 25, mataKuliah: matkul7G),
                             KomponenNilai(nama: "Tugas", bobot: 20, mataKuliah: matkul7G),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul7G)]
        let matkul7H = MataKuliah(nama: "Pengantar Rekayasa dan Desain", sks: 3, semester: semester7)
        matkul7H.komponen = [KomponenNilai(nama: "Proyek", bobot: 10, mataKuliah: matkul7H),
                             KomponenNilai(nama: "Praktikum", bobot: 20, mataKuliah: matkul7H),
                             KomponenNilai(nama: "Quis", bobot: 10, mataKuliah: matkul7H),
                             KomponenNilai(nama: "UTS", bobot: 30, mataKuliah: matkul7H),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul7H)]
        let matkul7I = MataKuliah(nama: "Bahasa Indonesia", sks: 3, semester: semester7)
        matkul7I.komponen = [KomponenNilai(nama: "Praktikum", bobot: 15, mataKuliah: matkul7I),
                             KomponenNilai(nama: "Tugas", bobot: 15, mataKuliah: matkul7I),
                             KomponenNilai(nama: "Quis", bobot: 10, mataKuliah: matkul7I),
                             KomponenNilai(nama: "UTS", bobot: 30, mataKuliah: matkul7I),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul7I)]
        let matkul7J = MataKuliah(nama: "Bahasa Inggris III", sks: 2, semester: semester7)
        matkul7J.komponen = [KomponenNilai(nama: "Tugas", bobot: 15, mataKuliah: matkul7J),
                             KomponenNilai(nama: "Quis", bobot: 15, mataKuliah: matkul7J),
                             KomponenNilai(nama: "UTS", bobot: 35, mataKuliah: matkul7J),
                             KomponenNilai(nama: "UAS", bobot: 35, mataKuliah: matkul7J)]
        let matkul7K = MataKuliah(nama: "Sistem Biologi", sks: 3, semester: semester7)
        matkul7K.komponen = [KomponenNilai(nama: "Proyek", bobot: 10, mataKuliah: matkul7K),
                             KomponenNilai(nama: "Praktikum", bobot: 20, mataKuliah: matkul7K),
                             KomponenNilai(nama: "Quis", bobot: 10, mataKuliah: matkul7K),
                             KomponenNilai(nama: "UTS", bobot: 30, mataKuliah: matkul7K),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul7K)]
        
        semester7.mataKuliah = [matkul7A, matkul7B, matkul7C, matkul7D, matkul7E, matkul7F, matkul7H, matkul7I, matkul7J, matkul7K]
        ...
        let matkul8B = MataKuliah(nama: "Sidang Sarjana", sks: 2, semester: semester8)
        matkul8B.komponen = [KomponenNilai(nama: "Sidang Sarjana", bobot: 100, mataKuliah: matkul8B)]
        let matkul8C = MataKuliah(nama: "Perancangan Pabrik", sks: 3, semester: semester8)
        ...
        let matkul8D = MataKuliah(nama: "Ekologi Industri", sks: 3, semester: semester8)
        ...
        let matkul8E = MataKuliah(nama: "Biomaterial", sks: 3, semester: semester8)
        matkul8E.komponen = [KomponenNilai(nama: "Praktikum", bobot: 20, mataKuliah: matkul8E),
                             KomponenNilai(nama: "Quis", bobot: 20, mataKuliah: matkul8E),
                             KomponenNilai(nama: "UTS", bobot: 30, mataKuliah: matkul8E),
                             KomponenNilai(nama: "UAS", bobot: 30, mataKuliah: matkul8E)]
        let matkul8F = MataKuliah(nama: "Keteknowiraan", sks: 3, semester: semester8)
        matkul8F.komponen = [KomponenNilai(nama: "Praktikum", bobot: 25, mataKuliah: matkul8F),
                             KomponenNilai(nama: "Quis", bobot: 20, mataKuliah: matkul8F),
                             KomponenNilai(nama: "UTS", bobot: 35, mataKuliah: matkul8F),
                             KomponenNilai(nama: "UAS", bobot: 20, mataKuliah: matkul8F)]
        semester8.mataKuliah = [matkul8A, matkul8B, matkul8C, matkul8D, matkul8E, matkul8F]
